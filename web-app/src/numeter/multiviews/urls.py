...
urlpatterns = patterns('',
    ...
    url(r'^customize/source/(?P<source_id>\d+)$', 'multiviews.views.customize.source_edit', name='multiviews customize source edit'),
    url(r'^customize/view$', 'multiviews.views.customize.view_index', name='multiviews customize view index'),
    url(r'^customize/view/list$', 'multiviews.views.customize.view_list', name='multiviews customize view list'),
    url(r'^customize/view/(?P<view_id>\d+)$', 'multiviews.views.customize.view_edit', name='multiviews customize view edit'),
