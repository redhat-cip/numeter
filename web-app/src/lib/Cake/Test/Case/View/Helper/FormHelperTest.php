 ...
 */
	public $validate = array(
		...
		'imrequinumeterupdate' => array('notEmpty' => array('rule' => 'alphaNumeric', 'on' => 'update')),
		'imrequinumetercreate' => array('required' => array('rule' => 'alphaNumeric', 'on' => 'create')),
		'imrequinumeterboth' => array(
 ...
 */
	public function testRequiredOnCreate() {
		...
		$result = $this->Form->input('Contact.imrequinumeterupdate');
		$expected = array(
			'div' => array('class' => 'input text'),
			'label' => array('for' => 'ContactImrequinumeterupdate'),
			'Imrequinumeterupdate',
			'/label',
			'input' => array(
				'type' => 'text', 'name' => 'data[Contact][imrequinumeterupdate]',
				'id' => 'ContactImrequinumeterupdate'
			),
			'/div'
		);
		$this->assertTags($result, $expected);

		$result = $this->Form->input('Contact.imrequinumetercreate');
		$expected = array(
			'div' => array('class' => 'input text required'),
			'label' => array('for' => 'ContactImrequinumetercreate'),
			'Imrequinumetercreate',
			'/label',
			'input' => array(
				'type' => 'text', 'name' => 'data[Contact][imrequinumetercreate]',
				'id' => 'ContactImrequinumetercreate'
			),
			'/div'
		);
		$this->assertTags($result, $expected);

		$result = $this->Form->input('Contact.imrequinumeterboth');
		$expected = array(
			'div' => array('class' => 'input text required'),
			'label' => array('for' => 'ContactImrequinumeterboth'),
			'Imrequinumeterboth',
			'/label',
			'input' => array(
				'type' => 'text', 'name' => 'data[Contact][imrequinumeterboth]',
				'id' => 'ContactImrequinumeterboth'
			),
			'/div'
		);
		$this->assertTags($result, $expected);
