...
INSERT INTO  `users` (`id` ,`username` ,`password` ,`isadmin`, `graph` ,`created` ,`modified`)VALUES (1 ,  'admin',  'f99550a09dda1afdc4e8e5dd22e9bcae75db7b1d',  '1', 0, NULL , NULL);
...
INSERT INTO  `group_user_memberships` (`id` ,`user_id` ,`group_id`) VALUES (NULL ,  '1',  '1');
